...
if(global.attack == obj_grenade && instance_exists(ball_player)) {
	//game_end()
    if(global.ammo > 0 && global.shop == false && global.stun == 0 && reload == 0 && ball_player.jam == 0) {
		...
		node_send(buffer,"eventName","Bullet","Num",ball_player.num,"X",xp,"Y",yp,"Dir",dir,"Obj",global.attack,"Timer",timer)

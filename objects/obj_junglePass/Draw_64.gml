...
if(garren > 0) {
	...
	if(regen > 0) {
		draw_sprite(spr_heal,0,xp,60)
		draw_healthbar(xp-30,80,xp+30,90,regen/18,c_dkgray,c_white,c_white,0,true,true)
		xp += 80;
	}
	if(spd > 0) {
		draw_sprite(spr_speed,0,xp,60)
		draw_healthbar(xp-30,80,xp+30,90,spd/12,c_dkgray,c_white,c_white,0,true,true)
		xp += 80;
	}
	if(dmg > 0) {
